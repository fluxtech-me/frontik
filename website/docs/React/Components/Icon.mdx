...
**Icon** component gives us simple and pixel perfect icon solutions that providing three main services: vector icon packs, the IcoMoon App, and hosting icons as SVGs or fonts
...
To update or to modify the current icons list we should have selection.json file and use it within the Icommon portal
...
```jsx
<Icon size='xs' name='frontik frontik-earth' />
<Icon size='sm' name='frontik frontik-heart' />
<Icon size='md' name='frontik frontik-frontik-spinner6' />
...
<a target="\_blank" href='/data/selection.json' download> Download selection.json</a>
