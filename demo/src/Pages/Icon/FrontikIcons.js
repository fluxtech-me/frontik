...
export default () => {
    ...
    return (
        <>
            <div className="rowed">
                <button className="toggler" onClick={showListHandler}>Show Frontik Icons List</button>
                <h2 className="responsive-title xs">Font Name: 'Frontik' <small className="fgc1">(Glyphs: {frontikIconsList.length})</small></h2>
            </div>
            <br/>
            {
                showIconsList ? (
